...
func dataAppTml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/app.tml", size: 77, mode: os.FileMode(420), modTime: time.Unix(1453565995, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _dataDevApiTml = []byte(`[api]
token = "qaw35dRtgyhtpDdDA21vgbjmyr43474kkdj"
`)

func dataDevApiTmlBytes() ([]byte, error) {
	return _dataDevApiTml, nil
}

func dataDevApiTml() (*asset, error) {
	bytes, err := dataDevApiTmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "data/dev/api.tml", size: 52, mode: os.FileMode(420), modTime: time.Unix(1453565999, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _dataTestApiTml = []byte(`[api]
token = "qaw35dRtgyhtpDdDA21vgbjmyr43474kkdj"`)

func dataTestApiTmlBytes() ([]byte, error) {
	return _dataTestApiTml, nil
}

func dataTestApiTml() (*asset, error) {
	bytes, err := dataTestApiTmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "data/test/api.tml", size: 51, mode: os.FileMode(420), modTime: time.Unix(1453566009, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
